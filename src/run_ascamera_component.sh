...
cd $CUR_DIR/composition/libs/lib/${gcc_target}
libPath=$(pwd)
...
# ros2 launch ascamera_component ascamera_composition.launch.py 2>&1 | tee $log_file
ros2 launch ascamera_component ascamera_composition.launch.py